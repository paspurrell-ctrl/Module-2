...
\newpage
\begin{abstract}
    My findings consisted of the advantages and limitations of exponential, linear, and logistic growth models. It explains in depth each differential equation, explicit equation, and corresponding graph.
\end{abstract}
...
Artificial intelligence (ChatGPT) was used to aid in this research paper specifically for brainstorming ideas. I also used it to help with my SageMath graphs and inserting them into Overleaf. I thoroughly reviewed and done extra research to make sure the information I received was reliable.
\end{document}