...
\newpage
\begin{abstract}
    My findings consisted of the advantages and limitations of exponential, linear and logistic growth models. It also explains in depth each differential equation, explicit equation, and graph.
\end{abstract}
